...
double compute_gradientCPU(dataPoint *dy, double *timeFrep, double *timeFattr,
                           tsneparams params, dataPoint *y,BiCsb<dataPoint,unsigned int>* csb) {
...
void kl_minimizationCPU(coord *y, tsneparams params, BiCsb<matval, matidx> *csb) {
  ...
  for (int iter = 0; iter < max_iter; iter++) {
    ...
    //if (timeInfo == NULL)
      ...
      zeta = compute_gradientCPU(dy, &timeFrep, &timeFattr, params, y,csb);
