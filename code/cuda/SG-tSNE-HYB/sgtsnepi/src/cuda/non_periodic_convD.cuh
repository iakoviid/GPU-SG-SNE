...
void conv1dnopadcuda(double *PhiGrid, double *VGrid, double h,
                     uint32_t *const nGridDims, uint32_t nVec, int nDim,  cufftHandle& plan,cufftHandle& plan_rhs, ComplexD *Kc,
                     ComplexD *Xc);
void conv2dnopadcuda(double *const PhiGrid, const double *const VGrid,
                     const double h, uint32_t *const nGridDims,
                     const uint32_t nVec, const uint32_t nDim,  cufftHandle& plan,cufftHandle& plan_rhs, ComplexD *Kc,
                     ComplexD *Xc);
