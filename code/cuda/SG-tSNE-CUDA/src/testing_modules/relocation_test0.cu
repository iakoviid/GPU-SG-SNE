...
/*
    int* ib_c = (int *)calloc(points, sizeof(int));
    int* cb_c = (int *)calloc(points, sizeof(int));
    cudaMemcpy(ib_c, ib, points * sizeof(int), cudaMemcpyDeviceToHost);
