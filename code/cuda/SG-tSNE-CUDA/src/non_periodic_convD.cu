...
void conv1dnopadcuda(double *PhiGrid, double *VGrid, double h,
                     uint32_t *const nGridDims, uint32_t nVec, int nDim,cufftHandle &plan,
                     cufftHandle &plan_rhs, ComplexD *Kc,
                     ComplexD *Xc)
{
  ...
  /*even*/
  setDataFft1D<<<Blocks, Threads, 0, streamRep>>>(Kc, Xc, n1, nVec, VGrid, hsq, 1);

  //cudaDeviceSynchronize(streamRep);
  ...
  ComplexPointwiseMulAndScale<<<Blocks, Threads, 0, streamRep>>>(Xc, Kc, n1, nVec);

  cufftExecZ2Z(plan_rhs, reinterpret_cast<cufftDoubleComplex *>(Xc),
               reinterpret_cast<cufftDoubleComplex *>(Xc), CUFFT_INVERSE);
  addToPhiGrid<<<Blocks, Threads, 0, streamRep>>>(Xc, PhiGrid, n1 * nVec, (0.5 / n1));
...
void conv2dnopadcuda(double *const PhiGrid, const double *const VGrid,
                     ...
                     const uint32_t nVec, const uint32_t nDim,cufftHandle &plan,
                     cufftHandle &plan_rhs, ComplexD *Kc,
                     ComplexD* Xc)
{
  double hsq = h * h;
  ...
  setDataFft2D<<<Blocks, Threads, 0, streamRep>>>(Kc, Xc, n1, n2, nVec, VGrid, hsq, 1, 1);
  cufftExecZ2Z(plan, reinterpret_cast<cufftDoubleComplex *>(Kc),
               reinterpret_cast<cufftDoubleComplex *>(Kc), CUFFT_FORWARD);
  cufftExecZ2Z(plan_rhs, reinterpret_cast<cufftDoubleComplex *>(Xc),
               reinterpret_cast<cufftDoubleComplex *>(Xc), CUFFT_FORWARD);

  ComplexPointwiseMulAndScale<<<Blocks, Threads, 0, streamRep>>>(Xc, Kc, n1 * n2, nVec);

  cufftExecZ2Z(plan_rhs, reinterpret_cast<cufftDoubleComplex *>(Xc),
               reinterpret_cast<cufftDoubleComplex *>(Xc), CUFFT_INVERSE);
  addToPhiGrid<<<Blocks, Threads, 0, streamRep>>>(Xc, PhiGrid, n1 * n2 * nVec, (0.25 / (n1 * n2)));
  ...
  cufftExecZ2Z(plan_rhs, reinterpret_cast<cufftDoubleComplex *>(Xc),
               reinterpret_cast<cufftDoubleComplex *>(Xc), CUFFT_INVERSE);
  normalizeInverse2D<<<Blocks, Threads, 0, streamRep>>>(Xc, n1, n2, nVec, -1, 1);
  addToPhiGrid<<<Blocks, Threads, 0, streamRep>>>(Xc, PhiGrid, n1 * n2 * nVec, (0.25 / (n1 * n2)));
...
void term3D(ComplexD *Kc, ComplexD *Xc, uint32_t n1, uint32_t n2, uint32_t n3,
  ...
  setDataFft3D<<<Blocks, Threads, 0, streamRep>>>(Kc, Xc, n1, n2, n3, nVec, VGrid, hsq, signx, signy,
                            signz);
  ...
  ComplexPointwiseMulAndScale<<<Blocks, Threads, 0, streamRep>>>(Xc, Kc, n1 * n2*n3, nVec);

  cufftExecZ2Z(plan_rhs, reinterpret_cast<cufftDoubleComplex *>(Xc),
               reinterpret_cast<cufftDoubleComplex *>(Xc), CUFFT_INVERSE);
  if(signx==-1 || signy==-1 || signz==-1){
  normalizeInverse3D<<<Blocks, Threads, 0, streamRep>>>(Xc, n1, n2, n3, nVec, signx, signy, signz);}
  addToPhiGrid<<<Blocks, Threads, 0, streamRep>>>(Xc, PhiGrid, n1 * n2 * n3 * nVec,
                            (0.125 / (n1 * n2 * n3)));
}
