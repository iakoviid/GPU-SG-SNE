...
template<typename T>
void checkResultsEps(const T* const ref, const T* const gpu, size_t numElem, coord eps1, coord eps2) {
  ...
  coord percentSmallDifferences = (coord)numSmallDifferences / (coord)numElem;
...
template<typename T>
void checkResultsAutodesk(const T* const ref, const T* const gpu, size_t numElem, coord variance, size_t tolerance)
{
