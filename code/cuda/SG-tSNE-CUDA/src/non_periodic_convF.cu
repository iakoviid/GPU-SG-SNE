...
extern int Blocks;
extern int Threads;
// ComplexF pointwise multiplication
static __global__ void ComplexPointwiseMulAndScale(ComplexF *a, const ComplexF *b,
...
__global__ void setDataFft2D(ComplexF *Kc, ComplexF *Xc, int n1, int n2, int nVec,
...
__global__ void addToPhiGrid(ComplexF *Xc, float *PhiGrid, int ng, float scale) {
...
void conv2dnopadcuda(float *const PhiGrid, const float *const VGrid,
  ...
  setDataFft2D<<<Blocks, Threads, 0, streamRep>>>(Kc, Xc, n1, n2, nVec, VGrid, hsq,
                                              1, 1);
...
__global__ void setDataFft3D(ComplexF *Kc, ComplexF *Xc,const int n1,const int n2,const int n3,
...
void term3D(ComplexF *Kc, ComplexF *Xc, uint32_t n1, uint32_t n2, uint32_t n3,
  ...
  setDataFft3D<<<Blocks, Threads, 0, streamRep>>>(Kc, Xc, n1, n2, n3, nVec, VGrid,
