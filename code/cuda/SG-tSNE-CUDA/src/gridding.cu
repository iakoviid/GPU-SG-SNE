...
#define shared true
void s2g(coord *VGrid, coord *y, coord *VScat, uint32_t nGridDim, uint32_t n,
         uint32_t d, uint32_t m, int *ib) {
...
__device__ __inline__ void WarpReduce2V1D(coord *V, coord *partial_sum,
