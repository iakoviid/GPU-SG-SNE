...
void eee(coord *const PhiGrid, const coord *VGrid, std::complex<coord> *Xc,
         std::complex<coord> *Kc, std::complex<coord> *wc,
         fftw_plan planc_kernel, fftw_plan planc_rhs, fftw_plan planc_inverse,
         uint32_t n1, uint32_t n2, uint32_t n3, uint32_t nVec, coord hsq) {
  ...
  for (uint32_t k = 0; k < n3; k++) {
    for (uint32_t j = 0; j < n2; j++) {
      for (uint32_t i = 0; i < n1; i++) {
        std::complex<coord> tmp(kernel3dCPU(hsq, i, j, k), 0);
...
void oee(coord *const PhiGrid, const coord *VGrid, std::complex<coord> *Xc,
         std::complex<coord> *Kc, std::complex<coord> *wc,
         fftw_plan planc_kernel, fftw_plan planc_rhs, fftw_plan planc_inverse,
         uint32_t n1, uint32_t n2, uint32_t n3, uint32_t nVec, coord hsq) {
  for (int pa = 0; pa < n1 * n2 * n3; pa++) {
...
void eoe(coord *const PhiGrid, const coord *VGrid, std::complex<coord> *Xc,
         std::complex<coord> *Kc, std::complex<coord> *wc,
         fftw_plan planc_kernel, fftw_plan planc_rhs, fftw_plan planc_inverse,
         uint32_t n1, uint32_t n2, uint32_t n3, uint32_t nVec, coord hsq) {
...
void ooe(coord *PhiGrid, const coord *VGrid, std::complex<coord> *Xc,
         std::complex<coord> *Kc, std::complex<coord> *wc,
         fftw_plan planc_kernel, fftw_plan planc_rhs, fftw_plan planc_inverse,
         uint32_t n1, uint32_t n2, uint32_t n3, uint32_t nVec, coord hsq) {
...
void eeo(coord *PhiGrid, const coord *VGrid, std::complex<coord> *Xc,
         std::complex<coord> *Kc, std::complex<coord> *wc,
         fftw_plan planc_kernel, fftw_plan planc_rhs, fftw_plan planc_inverse,
         uint32_t n1, uint32_t n2, uint32_t n3, uint32_t nVec, coord hsq) {
...
void oeo(coord *PhiGrid, const coord *VGrid, std::complex<coord> *Xc,
         std::complex<coord> *Kc, std::complex<coord> *wc,
         fftw_plan planc_kernel, fftw_plan planc_rhs, fftw_plan planc_inverse,
         uint32_t n1, uint32_t n2, uint32_t n3, uint32_t nVec, coord hsq) {
...
void eoo(coord *PhiGrid, const coord *VGrid, std::complex<coord> *Xc,
         std::complex<coord> *Kc, std::complex<coord> *wc,
         fftw_plan planc_kernel, fftw_plan planc_rhs, fftw_plan planc_inverse,
         uint32_t n1, uint32_t n2, uint32_t n3, uint32_t nVec, coord hsq) {
  for (int pa = 0; pa < n1 * n2 * n3; pa++) {
...
void ooo(coord *PhiGrid, const coord *VGrid, std::complex<coord> *Xc,
         std::complex<coord> *Kc, std::complex<coord> *wc,
         fftw_plan planc_kernel, fftw_plan planc_rhs, fftw_plan planc_inverse,
         uint32_t n1, uint32_t n2, uint32_t n3, uint32_t nVec, coord hsq) {
