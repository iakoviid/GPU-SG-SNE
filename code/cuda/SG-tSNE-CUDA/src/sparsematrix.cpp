...
void symmetrizeMatrix( sparse_matrix<dataPoint> *P ){
  ...
  dataPoint* sym_val_P = (dataPoint*) malloc(no_elem * sizeof(dataPoint));
...
void permuteMatrix( sparse_matrix<dataPoint> *P, int *perm, int *iperm ){
  ...
  dataPoint* perm_val_P = (dataPoint*) malloc( nnz    * sizeof(dataPoint));
...
template
void free_sparse_matrix(sparse_matrix<float> * P);
template
uint32_t makeStochastic(sparse_matrix<float> P);
template
void printSparseMatrix( sparse_matrix<float> P );
template
void symmetrizeMatrix( sparse_matrix<float> *P );
template
void permuteMatrix( sparse_matrix<float> *P, int *perm, int *iperm );


template
void free_sparse_matrix(sparse_matrix<double> * P);
template
uint32_t makeStochastic(sparse_matrix<double> P);
template
void printSparseMatrix( sparse_matrix<double> P );
template
void symmetrizeMatrix( sparse_matrix<double> *P );
template
void permuteMatrix( sparse_matrix<double> *P, int *perm, int *iperm );
